...
def main():
    ...
    parser.add_argument('files', metavar='fname',type=str, nargs='+', default=None,
                   help='Tomography, BrightField and DarkField txrm files in the order that have to be processed')   
    parser.add_argument('-o','--files_order', type=str, default='s', 
        help="Indicates the order in which the sample file 's', bright fields 'b' and dark fields 'd' have to be processed")   
    parser.add_argument('-zi','--zero-deg-in', type=str, default=None, 
        help="Image at 0 degrees taken before the tomography acquisition.")
    parser.add_argument('-zf','--zero-deg-final', type=str, default=None, 
        help="Image at 0 degrees taken at the end of the tomography acquisition.")  
    ...
    nexus = txrmnex.txrmNXtomo(args.files, args.files_order, args.zero_deg_in, args.zero_deg_final, args.title, 
                            args.source_name, args.source_type, args.source_probe, args.instrument_name, 
                            args.sample_name)
