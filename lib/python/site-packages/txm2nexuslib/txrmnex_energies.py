...
class xrmReader(object):
    ...
    def get_sample_name(self):
        ...
        if splitted_file[1].find("tomo") != -1:
            tomo_name = splitted_file[1]
            zone = splitted_file[2]
        else:
            tomo_name = splitted_file[2]
            zone = splitted_file[1]
        energy = splitted_file[3]
        pos_ext = splitted_file[-1].find('.xrm')
        conf = splitted_file[-1][:pos_ext]
        return '{0}_{1}_{2}_{3}_{4}'.format(splitted_file[0],
                                            tomo_name,
                                            zone,
                                            energy,
                                            conf)
