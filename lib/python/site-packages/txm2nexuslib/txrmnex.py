...
class xrmNXtomo(object):
    ...
    def __init__(self, reader, ffreader, file_order,
        ...
        splited_file = sample_name.split('_')
        sample_dir_name = '{0}_{1}'.format(splited_file[0], splited_file[1])
...
class xrmReader(object):
    ...
    def get_sample_name(self):
        ...
        if splited_file[1].find("tomo") != -1:
            tomo_name = splited_file[1]
        else:
            tomo_name = splited_file[2]
        pos_ext = splited_file[-1].find('.0.xrm')
        conf = splited_file[-1][:pos_ext]
        return '{0}_{1}_{2}'.format(splited_file[0],
                                    tomo_name,
                                    conf)
